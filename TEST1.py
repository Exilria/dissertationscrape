    ...
    for index, row in c_names.iterrows():
        ...
        for vid in all_vids_details:
            ...
            try:
                ...
                total_num_chats, total_superchat_earnings_usd, original_value, currency, usd_value, timestamps = get_superchats(yt_url)
                print('2')
                ...
                data_we_want[18] = gender
                data_we_want[19] = language
            ...
            continue
        print(data_we_want)
        df.to_csv('./data_csvs/data_'+str(index)+'.csv', index=False)
